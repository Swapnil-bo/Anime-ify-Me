...
- The backstory must have WEIGHT — reference a specific loss, a defining moment, a wound that never healed. 3 sentences. Make it hurt.
...
- The stat block uses 0-100 scale. Be honest — not everyone is 95 STR. Flaws make characters real.
- The anime universe must feel like a real fit — consider the tone, art style, and themes of that series
- The rival description should be one sentence — who would be their narrative foil?
- The theme song must be a real anime OST/opening that matches their energy
...
{{
  ...
  "backstory": "Three sentences. One wound. One defining moment. One unresolved truth they carry.",
  ...
  "anime_universe": "The specific anime they belong to and why it fits their soul",
  "rival": "One sentence describing their narrative foil and the nature of their conflict",
